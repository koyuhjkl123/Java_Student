...
public class Exam07_PersonTest {

	public static double average(ArrayList<Exam07_Person> person,ToDoubleFunction<Exam07_Person> s) {
//		매개 변수 2개 : 
...
//		총 더한 값 / size(5) 
	...
	public static void main(String[] args) {
		...
		double p1 = average(Exam07_Person.persons, age-> age.getAge());
		double p2 = average(Exam07_Person.persons, key-> key.getKey());
